...
use sts2_gateway::{
    GatewayRecoveryStore, RUNTIME_V3_SCHEMA_DIGEST, RecoveryIntentResult, RecoveryLease,
    RecoveryLeaseRequest, RecoveryOperationIntent, RecoveryOperationState,
...
#[path = "service_v3_catalog_duplicate_tests.rs"]
mod duplicate_tests;
