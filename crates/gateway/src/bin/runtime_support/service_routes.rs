...
impl RuntimeService {
    ...
    pub(super) fn runtime_v3_action_path(&self) -> String {
        format!("/v3/instances/{}/action", self.config.instance_id)
    }

    pub(super) fn runtime_v3_state_path(&self) -> String {
    ...
    pub(super) fn runtime_v3_operation_id<'a>(&self, path: &'a str) -> Option<&'a str> {
